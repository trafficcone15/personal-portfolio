...
const ParticleBoardSection = () => {
    ...
    const [isCanvasLoaded, setIsCanvasLoaded] = useState<boolean>(true);
    const { particles, setParticles, originalParticlesRef, particleBoardWidth, particleBoardHeight, haveParticlesBeenFetched } = useParticleBoard(`${apiUrl}/api/particles`, svgRef);
    ...
    return (
        <div className="particle-board-section-container section-container" id="mern-board">
            ...
            {!isCanvasLoaded && !haveParticlesBeenFetched ? (
